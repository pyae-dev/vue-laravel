...
<template>
    ...
    <div
        ...
        :class="cn('flex h-full w-[--sidebar-width] flex-col bg-red-100 text-sidebar-foreground', props.class)"
        v-bind="$attrs"
    >
        <slot />
    </div>
    ...
    >
        ...
        <div
            :class="
                cn(
                    'relative h-svh w-[--sidebar-width] bg-[#D7F1E3] transition-[width] duration-200 ease-linear',
